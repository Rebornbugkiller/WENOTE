...
[![PRs Welcome](https://img.shields.io/badge/PRs-welcome-brightgreen.svg)](https://github.com/Rebornbugkiller/WENOTE/pulls)

> WeNote 是一个全栈智能笔记 Web 应用，前端基于 Vue 3 + Element Plus，后端基于 Go + Gin，集成 AI 智能摘要与标签生成，具备完整的软删除机制、多级限流保护和熔断降级能力。
